...
// Khi nhấn nút Delete, lưu id người dùng
	...
	const handleSubmit = async (e) => {
		e.preventDefault();
		const data = await axios.post("/students/create", formData);
		console.log(data);
	...
	const handleUpdate = async (e) => {
		e.preventDefault()
		const data = await axios.put("/students/update", formDataEdit);
		if(data.data.success){
		...
		<div className="relative">
			...
			>
				<div className='flex justify-between items-center mb-6'>
					<h2 className='text-xl font-semibold text-gray-100'>Student</h2>
					<button
					...
					<table className='min-w-full divide-y divide-gray-700'>
						<thead>
							<tr>
								...
								<th className='px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider'>Sex</th>
						...
						<tbody className='divide-y divide-gray-700'>
							{ data[0] ? (
								...
								>
									...
									<td className='px-6 py-4 whitespace-nowrap'>
										<div className='text-sm text-gray-300'>{user.dateOfBirth}</div>
									</td>
									<td className='px-6 py-4 whitespace-nowrap'>
									...
									<td className='px-6 py-4 whitespace-nowrap'>
										<div className='text-sm text-gray-300'>{user.class}</div>
									</td>
